  ...
  module Model
    ...
    macro has_one(klass, *, rel_type, name = "", plural = "", unique = true)
      ...
      class ::Neo4jModel::QueryProxy(T)
        ...
        def {{@type.id.underscore}}_has_one_{{plural}}(assoc_obj_variable_name = :{{name}}, assoc_rel_variable_name = :r)
        ...
        def {{@type.id.underscore}}_has_one_{{name}}(assoc_obj_variable_name = :{{name}}, assoc_rel_variable_name = :r) : {{klass.id}}?
      ...
      def {{plural}}(assoc_obj_variable_name = :{{name}}, assoc_rel_variable_name = :r)
        ...
        proxy = query_proxy.{{@type.id.underscore}}_has_one_{{plural}}(assoc_obj_variable_name, assoc_rel_variable_name)
